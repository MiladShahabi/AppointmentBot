...
booking_time_offer_1 = '07:00'
booking_time_offer_2 = '10:30'

booking_month_1st = 'August'
booking_month_2nd = 'September'
booking_month_3rd = 'December'

prefered_start_day = 1 # August
prefered_end_day = 11 # August
prefered_day = 'deselect' # select

USER_CHAT_ID: Final = 566122101  # User's Chat ID
firstname = 'Iran' 
lastname = 'Marshalpirgheybi' 
dob = '22.04.1992' # DD.MM.YYYY 
email = 'iranmrshl@gmail.com' 
...
def recaptcha_solver():
    ...
    if is_checkmark_clean == ' recaptcha-checkbox-focused recaptcha-checkbox-checked':
        logging.info('reCaptcha has been solved only with just clicked')
        return
    else:
