...
option.add_extension("/usr/src/app/buster.crx")
...
booking_time_offer_2 = '11:30'

booking_month_1st = 'August'
booking_month_2nd = 'August'
...
def recaptcha_solver():
    ...
    if is_checkmark_clean == ' recaptcha-checkbox-focused recaptcha-checkbox-checked':
        ...
        #========================================================== 2Captcha algorithms ================================================
        logging.info(send_screenshot_to_telegram_channel(group_chat_id, 'xi-div-1', 'Status of auto reCaptcha solver'))
        actions = ActionChains(browser)
        actions.send_keys(Keys.TAB)
        actions.send_keys(Keys.TAB)
        actions.send_keys(Keys.ENTER)
...
def date_time_selection(arg1, arg2, arg3, arg4, arg5, arg6):
    # time.sleep(2)
    global option
    try:
        browser.implicitly_wait(3)
        ...
        if not select_month.text == arg3:
            ...
            if not select_month.text == arg4:
                ...
                if not select_month.text == arg5:
                    ...
                    raise NoSuchElementException 
        if not arg6 == '-':        
            if not select_day.text == arg6:
                logging.warning('-->>>The empty slot found is not equal to the preferred slot<<<--')
                raise NoSuchElementException
        select_day.click() 
...
while is_loop == 'true':
    try:
        ...
        service_selection()
        date_time_selection(booking_time_offer_1, booking_time_offer_2, booking_month_1st, booking_month_2nd, booking_month_3rd, prefered_days)
        is_loop = 'false'
