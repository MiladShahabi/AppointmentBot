...
email = 'milad.shahabi.20@gmail.com'
id_card_number = 'fgthggrr'
...
def send_screenshot_to_telegram_channel(chat_id, snapshot_area):
...
def nationality_selection(arg1, arg2, arg3, arg4):
    ...
    WebDriverWait(browser, 60).until(
        EC.text_to_be_present_in_element((By.CSS_SELECTOR, "label[for='xi-sel-400'] p:nth-child(1)"), 'Citizenship'))
    ...
    for i in range(60):
        ...
        if is_loading == '1':
            ...
            if is_loading == '1':
                ...
                break 
    # Check the Message after loading   
    browser.implicitly_wait(3)
...
ID Card Number: ```{id_card_number}```'''
    ...
    send_screenshot_to_telegram_channel(channel_chat_id, 'xi-div-1')
    send_message_to_admin(channel_chat_id, '[Appointment available for:]\n\n' + request_type)
...
def import_personal_data(arg1, arg2, arg3, arg4, arg5, arg6):
    ...
    if arg6 == 'Apply for a residence title': 
        ...
        logging.info('Do you currently have a residence title (e.g. a visa or a residence permit)? : no')  
    elif arg6 == 'Extend a residence title':
